...
curl -X POST \
      http://192.168.40.140:7777/admin/create \
...
curl -X GET \
  'http://192.168.40.140:7777/admin/salt?user_name=meoxumi1994' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo

curl -X POST \
      http://192.168.40.140:7777/admin/login \
      -H 'Cache-Control: no-cache' \
      -H 'Content-Type: application/json' \
      -H 'Postman-Token: bbc73dd3-a3fc-49a4-97b6-dac25ea563cf' \
      -d '{
...
curl -X GET \
  'http://192.168.40.140:7777/admin/get?user_id=1' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo
...
curl -X POST \
  http://192.168.40.140:7777/admin/event \
  -H 'Cache-Control: no-cache' \
  -H 'Content-Type: application/json' \
...
curl -X GET \
  'http://192.168.40.140:7777/admin/category' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc' \
  -H 'entry-task-token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..j70bvUUQJX2WZNsYUf3ENHYbRxMf4eO1NxGCx8PP9dg'
echo
...
curl -X POST \
  http://192.168.40.140:7777/admin/photo \
  -H 'Cache-Control: no-cache' \
  -H 'Content-Type: application/json' \
...
curl -X POST \
      http://192.168.40.140:7777/api/create \
      -H 'Cache-Control: no-cache' \
      -H 'Content-Type: application/json' \
      -H 'Postman-Token: bbc73dd3-a3fc-49a4-97b6-dac25ea563cf' \
      -d '{
...
curl -X GET \
  'http://192.168.40.140:7777/api/salt?user_name=tran' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo

curl -X POST \
      http://192.168.40.140:7777/api/login \
      -H 'Cache-Control: no-cache' \
      -H 'Content-Type: application/json' \
      -H 'Postman-Token: bbc73dd3-a3fc-49a4-97b6-dac25ea563cf' \
      -d '{
...
curl -X GET \
  'http://192.168.40.140:7777/api/get?user_id=1' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo
...
curl -X GET \
  'http://192.168.40.140:7777/api/event_get_by_id?event_id=1' \
  -H 'Cache-Control: no-cache' \
...
curl -X GET \
  'http://192.168.40.140:7777/api/event_search_by_tag?tag_name=coffee' \
  -H 'Cache-Control: no-cache' \
  -H 'Content-Type: application/json' \
...
curl -X GET \
  'http://192.168.40.140:7777/api/event_search_by_event_time?start_time=1533024509&end_time=1533024509' \
  -H 'Cache-Control: no-cache' \
  -H 'Content-Type: application/json' \
