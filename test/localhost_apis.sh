...
curl -X GET \
  'http://localhost:8000/admin/salt?user_name=tran%20minh%20123' \
  -H 'Cache-Control: no-cache' \
...
curl -X POST \
      http://localhost:8000/visitor/create \
      -H 'Cache-Control: no-cache' \
      -H 'Content-Type: application/json' \
      -H 'Postman-Token: bbc73dd3-a3fc-49a4-97b6-dac25ea563cf' \
      -d '{
...
curl -X GET \
  'http://localhost:8000/visitor/salt?user_name=tran' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo

curl -X POST \
      http://localhost:8000/visitor/login \
      -H 'Cache-Control: no-cache' \
      -H 'Content-Type: application/json' \
      -H 'Postman-Token: bbc73dd3-a3fc-49a4-97b6-dac25ea563cf' \
      -d '{
...
curl -X GET \
  'http://localhost:8000/visitor/get?user_id=1' \
  -H 'Cache-Control: no-cache' \
  -H 'Postman-Token: a6322d1a-2433-407b-a30e-6fdaa85890cc'
echo
